...
if __name__ == '__main__':
    ...
    run(['mysqlimport', '-u' + arg1, '-p' + arg2, '--local', 'github2', DB_FILES_ROOT + 'project.dat'])
    run(['mysqlimport', '-u' + arg1, '-p' + arg2, '--local', 'github2', DB_FILES_ROOT + 'github_user.dat'])
    run(['mysqlimport', '-u' + arg1, '-p' + arg2, '--local', 'github2', DB_FILES_ROOT + 'commit.dat'])
    run(['mysqlimport', '-u' + arg1, '-p' + arg2, '--local', 'github2', DB_FILES_ROOT + 'file_modification.dat'])
